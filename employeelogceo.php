...
<head>
  ...
  <title>CEO | Employee LOG</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
      ...
      <!-- Sidebar Menu -->
       <ul class="sidebar-menu">
        ...
        <li class="treeview">
         ...
         <li class="active"><a href="employeelogceo.php"><i class="fa fa-link"></i> <span>Employee Log</span></a></li>
...
<!-------------------------------- select table inventory ---------------------------------->
                        ...
                        <td><a href="empinfoceo.php <?php echo '?id='.$id; ?> ">Employee detail</a></td>
						</tr><?php }?>
							</table>
							</div>
							</form>
