...
<head>
  ...
  <title>Manager | Recruitment</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
     ...
     <div class="box box-default">
           ...
           <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
			<nav>
				<center><h2>Successful Candidate<h2></center>
				<div class="col-sm-12">
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
	                   $count_client=mysql_query("select * from tempstore where temp_status=0");
	                   $count = mysql_num_rows($count_client);
                       ?>	
                        <!-- block -->						
                        <div id="block_bg" class="block">	
							...
							<br>
                                <div class="muted pull-right">&nbsp;Candidate List&nbsp;&nbsp;</div><div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from tempstore where temp_status=0")or die(mysql_error());
													while($row = mysql_fetch_array($user_query)){
													$id = $row['temp_id'];
													?>
												...
												<td class="col-md-1">
												<a href="manapproval.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
