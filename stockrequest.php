...
<div class="col-sm-12">
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
					  $count=0;
	                  $count_client=mysql_query("SELECT * FROM stockorder WHERE stockorder.order_approve =0 ");
	                   $count = mysql_num_rows($count_client);
                       ?>	
                        <!-- block -->						
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("SELECT * FROM stockorder,stocklist WHERE stockorder.order_approve =0 and stocklist.item_id=stockorder.item_id ")or die(mysql_error());
												...
												<td><?php echo $row['order_itemamount']; ?></td>
											
												<td class="col-md-1">
												<a href="stockdetail.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
