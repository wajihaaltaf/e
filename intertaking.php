...
$id=$_GET['id'];
	...
	mysql_query("UPDATE test SET inter_taken=1 where test_id=$id")or die(mysql_error()); 	
?>
<script>
    ...
    <section class="content">
     <div class="box box-default">
		...
		<div class="col-md-12">
			...
			<h3><center>Interview Panel</center></h3>
			<br>
			<div>
				<div class="form-group">
							  ...
							  <div class="col-md-3">
					 <input type="text"  class="form-control" id="emp_name" name="emp_name" value="<?php echo $name?>" placeholder="Name"required autofocus>
				</div>
				</div>
							 	   <div class="form-group">
