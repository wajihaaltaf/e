 ...
 <div class="col-sm-12">
					  ...
					  $count=0;
                       ...
                       ?>	
                        ...
                        <div id="block_bg" class="block">	
							...
							<br>
                                <div class="muted pull-right">&nbsp;&nbsp;&nbsp; Loan Transaction</div><div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from leavereq where leave_approve=1 and Leave_type='Loan'")or die(mysql_error());
	...
	$qry=mysql_query($select);
		...
		while($rec = mysql_fetch_array($qry)){
												...
												<td class="col-md-1">
												<a href="loantransaction.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
