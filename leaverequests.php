...
<head>
  ...
  <title>Manager | Request</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
  ...
  <div class="content-wrapper">
       ...
       <div id="page-wrapper">
			...
			<nav>
				...
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
	                   $count_client=mysql_query("select * from leavereq where leave_type='Leave' and leave_approve=0");
	                   $count = mysql_num_rows($count_client);
                       ?>	
                        <!-- block -->						
                        <div id="block_bg" class="block">	
							...
							<br>
                                <div class="muted pull-right">&nbsp;&nbsp;&nbsp; Requests</div><div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  								...
  								<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from leavereq where leave_type='Leave' and leave_approve=0")or die(mysql_error());
													while($row = mysql_fetch_array($user_query)){
													$id = $row['leave_id'];
													$empid = $row['emp_id'];
	...
	$qry=mysql_query($select);
		...
		while($rec = mysql_fetch_array($qry)){
												...
												<td class="col-md-1">
												<a href="leaveapprove.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
