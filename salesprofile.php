...
<head>
  ...
  <title>Sales | Profile</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
...
<div class="control-group">
				<div class="controls" align="center">
						           				 <a href="updatesales.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
                                                 <a href="sales.php" class="btn btn-danger"><i class="glyphicon glyphicon-pencil"></i></a>
    <!-- /#wrapper -->
</div>
</td></table>
              </div>
