...
<?php
$id=$_GET['id'];
$select = "select * from stockorder,payment,stocklist where stockorder.order_id='$id'";
	...
	$qry=mysql_query($select);
		...
		$ide= "$rec[item_id]";
		$bal= "$rec[payment_balance]";
		$amount= "$rec[order_totalcost]"; }
		}
		
		if (isset($_POST['update'])){
	
	$oearly = $_POST['oearly'];
	if($oearly > $bal || $oearly > $amount) {?>
<script>
alert('Error Occured');
window.location = "#";
</script>
<?php }
	...
	$rem=$amount-$oearly;
		mysql_query("UPDATE `stockorder` SET `order_time` = NOW(), `order_earlypayment` = '$oearly', `order_approve` = '2',order_remainingpayment='$rem' WHERE `stockorder`.`order_id` = '$id'")or die(mysql_error());
		$final = $bal-$amount;
	mysql_query("INSERT INTO `payment` (`payment_id`, `payment_date`, `payment_debit`, `payment_credit`, `payment_balance`) VALUES (NULL, NOW(), '0', '$amount', '$final');")or die(mysql_error());
	
?>
<script>
alert('Payment Successful');
window.location = "stockrequests.php";
</script>
<?php
}}?>
...
<head>
  ...
  <title>Finance | Stock Transaction</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
...
<div class="wrapper"> <header class="main-header">
  ...
  <aside class="main-sidebar">
    ...
    <ul class="sidebar-menu">
       ...
       <li><a href="salary.php"><i class="fa fa-link"></i> <span>Salary</span></a></li> <li class="active"><a href="loan.php"><i class="fa fa-link"></i> <span>Loan</span></a></li>
        
        <li><a href="stockrequests.php"><i class="fa fa-link"></i> <span>Stock Request</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Stock Requests</li>
        <li class="active">Stock Transaction</li>
      </ol>
    </section>
    ...
    <section class="content">
     <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Stock Requests</h3>
              <br>
  <div id="page-wrapper" class="page-wrapper-cls">
		...
		<div class="col-md-12">
			...
			<h3><center>Stock Order Transaction</center></h3>
			<br>
			<div>
				<div class="form-group">
							  ...
							  <div class="col-md-3">
					 <input type="text"  class="form-control" id="emp_name" name="lamount" placeholder="Amount" value=<?php echo $amount; ?> required readonly>
				</div>
				</div>
                <div class="form-group">
							  <label class="col-md-5 control-label">Balance:</label>
							  <div class="col-md-3">
                                <input type="text"  class="form-control" id="emp_name" name="bamount" placeholder="Amount" value=<?php echo $bal; ?> required readonly>
					
					</div>
				</div>
                  <div class="form-group">
							  <label class="col-md-5 control-label">Order Early Payment:</label>
							  <div class="col-md-3">
                                <input type="text"  class="form-control" id="emp_name" name="oearly" placeholder="Amount" required>
				...
				<div class="controls" align="center">
												 ...
												 <a button id="cancel" name="cancel" class="btn btn-danger" href="stockrequests.php" >Cancel</button></a>
						           			 </div></div>
											 <br>
											 <br>
											 <br>
