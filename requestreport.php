...
<head>
  ...
  <title>CEO | Report</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <h2><i class="fa fa-users">&nbsp; Requests</i></h2>
    </div>
  ...
  <div class="col-sm-12">
				 ...
				 $count = mysql_num_rows($counts_client) + $count;
                       ...
                       ?>	
                        ...
                        <div id="block_bg" class="block">	
							...
							<br>
                                <div class="muted pull-right">Approve Requests</div><div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from tempstore where temp_status=1")or die(mysql_error());
													while($row = mysql_fetch_array($user_query)){
													$id = $row['temp_id'];
													?>
												...
												<td class="col-md-1">
												<a href="ceoapprove.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from leavereq where leave_type='Loan' and leave_approve=0")or die(mysql_error());
													while($row = mysql_fetch_array($user_query)){
													$id = $row['leave_id'];
													$empid = $row['emp_id'];
	...
	$qry=mysql_query($select);
		...
		while($rec = mysql_fetch_array($qry)){
												...
												<td><?php 
												echo $rec['emp_name']; ?></td>
	
												<td><?php echo $rec['emp_email']; ?></td>
											
												<td class="col-md-1">
												<a href="loanapprove.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
