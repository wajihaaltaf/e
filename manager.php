...
<head>
  ...
  <title>Manager | Dashboard</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <!-- The message -->
                      <p><?php echo $row['candidate_email']; }?></p>
                    </a>
                  </li>
                  <!-- end message -->
                </ul>
  ...
  <div class="box-footer">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="sendemailm.php" method="post">
