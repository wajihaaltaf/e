...
<div class="wrapper">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
				...
				?>
                  <small><?php echo $_SESSION['emp_position']; ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
     ...
     <li><a href="#"><i class="fa fa-link"></i> <span>Salary Transaction</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      DASHBOARD
        <small><?php echo $_SESSION['emp_email']; ?></small>
      </h1>
      <ol class="breadcrumb">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2016 <a href="#">TECHRISERS</a>.</strong> All rights reserved.
  </footer>
      ...
      <div class="tab-pane active" id="control-sidebar-home-tab">
        ...
        <ul class="control-sidebar-menu">
          <li>
			...
			$query=mysqli_query($con,"SELECT * FROM employee WHERE DATE_ADD(emp_dob, INTERVAL YEAR(CURDATE())-YEAR(emp_dob) + IF(DAYOFYEAR(CURDATE()) > DAYOFYEAR(emp_dob),1,0) YEAR) BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 1 YEAR) ORDER by emp_dob DESC limit 1 ")or die(mysql_error());
						while($row=mysqli_fetch_array($query)){
			 echo $row['emp_name'];  ?></h4>

                <p>Will be on <?php echo $row['emp_dob']; }?></p>
              </div>
            </a>
          </li>
        </ul>
