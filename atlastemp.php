...
<?php
$ide=$_GET['id'];
$select = "SELECT * FROM tempstore WHERE temp_id= $ide";			 
	...
	$pro = $_POST['proj_id'];
    $img = $_POST['image'];
	mysql_query("INSERT INTO `contract` (`con_id`, `con_sdate`, `con_edate`, `con_status`) VALUES ('', '$cdate', '$edate', '1')")or die(mysql_error());
	$select = "SELECT MAX(con_id) as cid FROM contract";
	$qry=mysql_query($select);
		if($qry)
		{
		while($rec = mysql_fetch_array($qry)){
	...
	mysql_query("INSERT INTO `employee` (`emp_id`, `dept_id`, `emp_name`, `emp_username`, `emp_password`, `emp_nic`, `emp_email`, `emp_status`, `emp_gender`, `emp_address`, `con_id`, `emp_position`, `on_leave`, `proj_id`, `emp_image`, `emp_DOB`) VALUES ('', '$dpt', '$fname', '$uname', '$password', '$nic', '$email', '1', '$gender', '$address', '$con', '$position', '0', '$pro', '$img', '$bdate')")or die(mysql_error());
				$select = "SELECT MAX(emp_id) as eid FROM employee";
	$qry=mysql_query($select);
		if($qry)
		{
		while($rec = mysql_fetch_array($qry)){
    ...
    <section class="content">
     <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">CEO Approved</h3>
              <br>
		...
		<div class="col-md-12">
			...
			<div>
				...
				<div class="form-group">
							  ...
							  <div class="col-md-3">
					<input type="number" name="water" id = "water" class="form-control input-md" placeholder="Amount" value="<?php echo $salary; ?>" required/> 
				</div>
				</div>
				<div> 
					<div class="form-group">
							  ...
							  <div class="col-md-3">
					<input type="text" name="fname" id = "fname" class="form-control input-md" placeholder="plase enter name" value="<?php echo $name; ?>" required/> 
						</div>
						</div>
				...
				<div class="form-group">
							  ...
							  <div class="col-md-3">
						<input type="text" name="address" id = "address" class="form-control input-md" placeholder="Address" value="<?php echo $address; ?>" required/>
					</div>
				</div>
				<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">Contact No.:</label>
							  <div class="col-md-3">
						<input type="text" name="contact" id = "contact" class="form-control input-md" title="input number only" placeholder="Contact Number" value="<?php echo $contact; ?>" required/>
					</div>
				</div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
							  ...
							  <div class="col-md-3">
						<input type="file" name="image" id = "password" class="form-control input-md" required/>
					</div>
				</div>
