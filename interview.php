     ...
     <div class="box box-default">
          ...
          <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
			<nav>
				<center><h2>Successful Candidates<h2></center>
				<div class="col-sm-12">
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from interview where inter_status=1 ")or die(mysql_error());
												...
												<td><?php echo $row['inter_email']; ?></td>
											
												<td class="col-md-1">
												<a href="hrapprove.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
