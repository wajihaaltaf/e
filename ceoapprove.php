...
$id = $_GET['id'];
	...
	$qry=mysql_query($select);
		...
		{
		mysql_query("UPDATE tempstore set temp_status =2 where temp_id = $id")or die(mysql_error());
				?>
				<script>
alert('Approved Succsessfully');
window.location = "ceopage.php";
</script>
<?php }
?>
<!DOCTYPE html>
...
<div class="control-group">
				<div class="controls" align="center">
												 ...
												 <a button id="cancel" name="cancel" class="btn btn-danger" href="disapproves.php<?php echo '?id='.$id; ?>" >Disapprove</button></a>
    <!-- /#wrapper -->
</div>
</td></table>
              </div>
