...
<head>
  ...
  <title>Sales | Dashboard</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
 ...
 <li><a href="employeelogsales.php"><i class="fa fa-link"></i> <span>Employee Log</span></a></li>
  ...
  <div class="content-wrapper">
	...
	$count_client=mysql_query("select * from tempstore where temp_status=1 ");
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-red"><i class="icon ion-android-person-add"></i></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-green"><i class="icon ion-ios-bookmarks-outline"></i></span>
	...
	$select = "SELECT COUNT(*) as count FROM employee";
			  $qry=mysql_query($select);
		$rec = mysql_fetch_array($qry);
		$count = "$rec[count]"; echo $count;?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
  ...
  <div class="box-footer">
          ...
          <div class="box box-info">
            ...
            <div class="box-footer clearfix">
              <a href="add_proj_sales.php" class="btn btn-sm btn-info btn-flat pull-left">Add New Project</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
