...
<?php
$id = $_GET['id'];
	$select = "SELECT * FROM `stocklist`,itemcategory,stockremaining,stockorder WHERE itemcategory.icategory_id=stocklist.icategory_id and stockremaining.item_id=stocklist.item_id and`stocklist`.`item_id`='$id'";
	//echo $select;
$qry=mysql_query($select);
		$rec = mysql_fetch_array($qry);
		$name = "$rec[item_name]";
		$email = "$rec[icategory_name]";
		$company = "$rec[item_company]";
		$imag="$rec[item_image]";
     $rem = "$rec[item_remaining]";
		$ord="$rec[order_itemamount]";
...
<head>
  ...
  <title>HR | Stock Detail</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Request</li>
          <li class="active">Stock Request</li>  <li class="active">Detail</li>
      </ol>
    </section>
...
<table>
	<tr>
		<td width="40%">
 <img src="data:image/jpeg;base64,<?php echo base64_encode($imag); ?>" width ="200px" height="200px" class="img-rounded" align="absbottom"/>
		</td>
        <td width="10%">
        </td>
		<td width="50%">
   <table><tr><td><h4>Product Name: </h4></td>
  <td><h4> <?php echo " $name" ?> </h4></td>
  </tr>
  <tr><td><h4>Prod Category: </h4></td>
  <td><h4> <?php echo "$email" ?> </h4></td>
  </tr>
  <tr><td><h4>Product Company: </h4></td>
  <td><h4> <?php echo " $company" ?> </h4></td>
  </tr>
  <tr><td><h4>Product Remaining: </h4></td>
  <td><h4> <?php echo " $rem" ?> </h4></td>
  </tr>
     <tr><td><h4>Product Ordered: </h4></td>
  <td><h4> <?php echo " $ord" ?> </h4></td>
  </tr>
   <tr><td><h4>Price for 1piece: </h4></td>
  <td><h4> <?php echo " $price" ?> </h4></td>
  </tr>
   <tr><td><h4>Total Amount: </h4></td>
...
<div class="control-group">
				<div class="controls" align="center">
						           				 <a button id="cancel" name="update" class="btn btn-success" href="stockapprove.php<?php echo '?id='.$id; ?>" >Approve</button></a>
												 <a button id="cancel" name="cancel" class="btn btn-danger" href="stockdisapprove.php<?php echo '?id='.$id; ?>" >Disapprove</button></a>
</td></table>
              </div>
