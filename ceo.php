...
<head>
  ...
  <title>CEO | Dashboard</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
  ...
  <div class="box-footer">
          ...
          <div class="box box-info">
            ...
            <div class="box-footer clearfix">
              <a href="add_proj_ceo.php" class="btn btn-sm btn-info btn-flat pull-left">Add New Project</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
