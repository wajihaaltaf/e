...
$result= mysql_query("SELECT * from stocklist,itemcategory WHERE stocklist.icategory_id=itemcategory.icategory_id ")or die(mysqli_error());
...
<head>
  ...
  <title>Sales | Stock Log</title><link rel="shortcut icon" href="assets/img/logocalc1.png">
...
<div class="empty">
<a href="#" class="btn btn-primary" onClick="window.print()" id="print" ><i class="fa fa-print"></i> Print Information</a></button>
</div>
</td></table>
              </div>
