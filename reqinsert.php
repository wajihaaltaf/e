    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Request</li>
          <li class="active">Check Request</li>
      </ol>
    </section>
...
<div class="col-sm-12">
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from leavereq where leave_approve=1 and (Leave_type='Leave' or Leave_type='Other') ")or die(mysql_error());
	...
	$qry=mysql_query($select);
		...
		while($rec = mysql_fetch_array($qry)){
												...
												<td class="col-md-1">
												<a href="leavewriter.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
