                ...
                <div>
                  ...
                  <div>
                    <div class="form-group">
                      ...
                      <div class="col-md-3">
                        <input type="radio" id="radio1" name="radios" value="Loan" checked>
                        <label for="radio1">Loan</label>
                        <input type="radio" id="radio2" name="radios"value="Leave">
                        <label for="radio2">Leave</label>
                         <input type="radio" id="radio2" name="radios"value="Others">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-3">
                      <textarea cols="50" rows="7" name="message" class="form-control input-md" required/>
                      </textarea>
                    </div>
                  </div>
