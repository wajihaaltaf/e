...
<?php
	...
	mysql_query("INSERT INTO `leavereq` VALUES ('', '$id', '$type', '', '', '', '', '', '$message','$subject')")or die(mysql_error());
				?>
				<script>
				...
				<div>
					...
					<input type="text" name="fname" id = "fname" class="form-control input-md" placeholder="name" value="<?php echo $name?>" required/> 
						...
						<div class="form-group">
							  ...
							  <div class="col-md-3">
					<input type="text" name="email" id = "email" class="form-control input-md"  placeholder="email" value="<?php echo $email?>" required/> 
					</div>
					</div>
<div>
					<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">Type:</label>
							  <div class="col-md-3">
					<div class="input-group">
    			<div id="radioBtn" class="btn-group">
					<a class="btn btn-primary btn-sm notActive" data-toggle="gender" data-title="Loan">Loan</a>
    				<a class="btn btn-primary btn-sm notActive" data-toggle="gender" data-title="Leave">Leave</a>
                    <a class="btn btn-primary btn-sm notActive" data-toggle="gender" data-title="Others">Others</a>
    			</div>
				...
				<button type="submit" id="submit" name="register" class="btn btn-success">Send</button>
				<br>
				<br>
				<br>
				<br>
