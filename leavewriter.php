...
$select = "SELECT emp_id FROM leavereq WHERE leave_id= $id";
	...
	$idate = $_POST['idate'];
	$days= $_POST['lday'];
	mysql_query("UPDATE `leavereq` SET `leave_sdate` = '$sdate', `leave_edate` = '$idate', `leave_nodays` = '$days', `leave_approve` = '2', `leave_continue` = '1' WHERE `leavereq`.`leave_id` = $id;")or die(mysql_error());	
	mysql_query("UPDATE employee set on_leave=1 where emp_id=$ide")or die(mysql_error()); 	
?>
<script>
		...
		<div class="col-md-12">
			...
			<div>
				<div class="form-group">
                                         ...
                                         <div class="form-group">
							  <label class="col-md-5 control-label">Leave Days:</label>
							  <div class="col-md-3">
					 <input type="text"  class="form-control" id="emp_name" name="lday" placeholder="Number of Days" required autofocus>
				</div>
				</div>
                 <div class="form-group">
							  <label class="col-md-5 control-label">Leave Start Date:</label>
							  <div class="col-md-3">
						<input type="date" name="tdate" placeholder="yyyy-mm-dd" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" title="YYYY-MM-DD" required />
					</div>
				</div>
                <div class="form-group">
							  <label class="col-md-5 control-label">Leave End Date:</label>
							  <div class="col-md-3">
				...
				<div class="controls" align="center">
												 ...
												 <a button id="cancel" name="cancel" class="btn btn-danger" href="adminpage.php" >Cancel</button></a>
						           			 </div></div>
											 <br>
											 <br>
											 <br>
