...
window.location = "add_proj_ceo.php";
</script>
<?php
}?>
<!DOCTYPE html>
...
<head>
  ...
  <title>CEO | Add Project</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
