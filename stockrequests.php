...
<head>
  ...
  <title>Finance | Stock Request</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
    ...
    <section class="content">
     <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Stock Order Requests</h3>
              <br>
 <div class="col-sm-12">
				<div class="span7" id="">  
                     <div class="row-fluid">
					  <?php	
					  $count=0;
	                   $count_client=mysql_query("SELECT * from stocklist,itemcategory,stockremaining,stockorder WHERE stocklist.item_id=stockremaining.item_id and stockremaining.item_isordered=1 and stockorder.order_approve=1 and stocklist.icategory_id=itemcategory.icategory_id and stockremaining.item_id=stocklist.item_id and stockorder.item_id=stocklist.item_id");
	                   $count = mysql_num_rows($count_client);
                       ?>	
                        <!-- block -->						
                        <div id="block_bg" class="block">	
							...
							<br>
                                <div class="muted pull-right">&nbsp;&nbsp;&nbsp; Stock Order Requests</div><div class="muted pull-right"><span class="label label-warning"><?php echo $count;?></span></div>
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("SELECT * from stocklist,itemcategory,stockremaining,stockorder WHERE stocklist.item_id=stockremaining.item_id and stockremaining.item_isordered=1 and stockorder.order_approve=1 and stocklist.icategory_id=itemcategory.icategory_id and stockremaining.item_id=stocklist.item_id and stockorder.item_id=stocklist.item_id")or die(mysql_error());
		...
		if($row)
		{
			?>
												...
												<td><?php echo $row['order_itemamount']*$row['item_price']; ?></td>
											
												<td class="col-md-1">
												<a href="stocktransaction.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
