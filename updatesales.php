...
window.location = "updatesales.php";
</script>
			<?php
			exit();
			}
...
window.location = "salesprofile.php";
</script>
<?php
}
else {
...
<head>
  ...
  <title>Sales | Update Profile</title><link rel="shortcut icon" href="assets/img/logocalc1.png">
 ...
 <div class="form-group">
               ...
               <div class="control-group">
				<div class="controls" align="center">
												 ...
												 <a button id="cancel" name="cancel" class="btn btn-danger" href="sales.php" >Cancel</button></a>
						           			 </div></div>
											 <br>
											 <br>
											 <br>
