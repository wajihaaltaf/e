    ...
    <section class="content">
     <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Interview Result</h3>
                            ...
                            <div class="block-content collapse in">
								...
								<!-----------------------form --------------------->
  									...
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
										...
										<tbody>
													<?php
													$user_query = mysql_query("select * from test where test_status=1 and inter_taken=0")or die(mysql_error());
												...
												<td class="col-md-1">
												<a href="intertaking.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i></a>
