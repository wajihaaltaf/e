...
$id = $_GET['id'];
	...
	mysql_query("INSERT INTO `tempstore` (`temp_id`, `name`, `position`, `username`, `gender`, `email`, `bdate`, `address`, `contact`, `salary`, `temp_status`, `password`, `con_date`, `proj_id`, `con_edate`, `nic`) VALUES ('', '$fname', '$position', '', '$gender', '$email', '$bdate', '$address', '$contact', '', '0', '', '', '', '', '$nic')")or die(mysql_error());
		mysql_query("UPDATE `interview` SET `inter_status` = '2' WHERE `interview`.`inter_id` = $id")or die(mysql_error());
				?>
				<script>
		...
		<div class="col-md-12">
			...
			<div>
         	<div class="form-group">
							  <label class="col-md-5 control-label" for="room">Position:</label>  
							  <div class="col-md-3">
				...
				<div>
					<div class="form-group">
							  ...
							  <div class="col-md-3">
					<input type="text" name="fname" id = "fname" class="form-control input-md" placeholder="name" required/> 
						</div>
						</div>
                ...
                <div>
					<div class="form-group">
							  <label class="col-md-5 control-label" for="rental">NIC:</label>
							  <div class="col-md-3">
					<input type="text" name="nic" id = "nic" class="form-control input-md" placeholder="nic" required/> 
						</div>
						</div>
