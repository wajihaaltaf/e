...
window.location = "add_proj_sales.php";
</script>
<?php
}?>
...
<head>
  ...
  <title>Sales | Add Project</title><link rel="shortcut icon" href="assets/img/logocalc1.png"><script src="js/blockrightclick.js"></script>
